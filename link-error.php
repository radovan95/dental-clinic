            ...
            <p>
                <?php
                    if( isset($_SESSION['message']) AND !empty($_SESSION['message']) ):
                        ...
                        echo "<p style='margin-top: 20px'>You will be redirected in <span id=\"counter\">5</span> second(s).</p>
