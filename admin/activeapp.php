...
if($_POST['dentist_id']==1)
{
    $get_pro = "SELECT a.*,p.* FROM appointment a 
                JOIN dentist d ON a.d_id = d.dentist_id
                JOIN patient p ON a.p_id = p.patient_id WHERE d.dentist_id = $dentist AND status = '0'";
