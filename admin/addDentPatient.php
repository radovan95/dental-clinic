        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <form method="post" action="addDentist.php">
                        <div class="card">
                            <div class="card-header"><strong>Patient</strong><small> Form</small></div>
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="street" class=" form-control-label">Email</label><input type="text" name="email" id="email" placeholder="Enter email" class="form-control"></div>
                                <div class="row form-group">
                                    <div class="col-8">
                                        <div class="form-group"><label for="city" class=" form-control-label">Address</label><input type="text" name="address" id="address" placeholder="Enter your address" class="form-control"></div>
                                    </div>
                                    <div class="col-8">
                                        <div class="form-group"><label for="postal-code" class=" form-control-label">Phone</label><input type="text" name="phone" id="phone" placeholder="Phone" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-group"><label for="country" class=" form-control-label">UPRN</label><input type="text" name="uprn" id="UPRN" placeholder="Unique Property Reference Number" class="form-control"></div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group"><label for="company" class=" form-control-label">First name</label><input type="text" id="first_name" placeholder="First name" class="form-control"></div>
                                <div class="form-group"><label for="vat" class=" form-control-label">Last name</label><input type="text" id="Last_name" placeholder="Last name" class="form-control"></div>
                                <div class="form-group"><label for="street" class=" form-control-label">Proffesion</label><input type="text" id="proffesion" placeholder="Enter proffesion" class="form-control"></div>
                                <div class="row form-group">
                                    <div class="col-8">
                                        <div class="form-group"><label for="city" class=" form-control-label">Email</label><input type="text" id="Email" placeholder="Enter your email" class="form-control"></div>
                                    </div>
                                    <div class="col-8">
                                        <div class="form-group"><label for="postal-code" class=" form-control-label">Password</label><input type="text" id="password" placeholder="Password" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-group"><label for="country" class=" form-control-label">Phone</label><input type="text" id="Phone" placeholder="Unique Property Reference Number" class="form-control"></div>
                                <div class="form-group"><label for="country" class=" form-control-label">Working time</label><input type="text" id="Phone" placeholder="Working time" class="form-control"></div>
